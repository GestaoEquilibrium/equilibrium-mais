...
(function () {
  ...
  function injetarCss() {
    ...
    .cp .cp-head{background:linear-gradient(135deg,#4F7634,#6E9A4A);color:#fff;padding:20px 24px}
    ...
    .cp .cp-corpo{padding:20px 24px;overflow-y:auto;flex:1;white-space:pre-wrap;font-size:13.5px;line-height:1.6;color:#2c3e50;background:#F6FAF0;border-bottom:1px solid #E3ECE0}
    ...
    .cp .cp-btn{font-family:'Quicksand',sans-serif;font-weight:600;border:none;border-radius:13px;padding:14px;font-size:15px;cursor:pointer;width:100%;background:#6E9A4A;color:#fff;transition:.18s}
    .cp .cp-btn:hover{background:#4F7634}
