...
(function () {
  ...
  const CV = `<svg width="44" height="44" viewBox="-55 -55 110 110">
    <g><path id="bl" d="M 13.2,-3.8 L 2.2,-3.8 Q 0,-3.8 0,-5.7 L 0,-46.6 Q 0,-48.5 1.9,-48.5 Q 3.9,-48.5 5.5,-46.6 L 24.4,-20.1 Q 25.2,-14 22.3,-8.4 Q 21,-6 19.4,-5.8 L 13.2,-3.8 Z" fill="#1b6cb3"/></g>
    <use href="#bl" fill="#F0B43C" transform="rotate(90)"/><use href="#bl" fill="#1b6cb3" transform="rotate(180)"/><use href="#bl" fill="#F0B43C" transform="rotate(270)"/></svg>`;
  ...
  function injetarCss() {
    ...
    s.id = "guia-css";
    s.textContent = `
    .guia-bg{position:fixed;inset:0;background:rgba(19,75,128,.5);backdrop-filter:blur(4px);display:none;align-items:flex-start;justify-content:center;z-index:1000;padding:24px;overflow:auto}
    ...
    .guia-bar{background:linear-gradient(135deg,#134b80,#1b6cb3);color:#fff;padding:16px 22px;display:flex;align-items:center;gap:12px}
    ...
    .guia-bar .baixar{background:#fff;color:#1b6cb3}
    ...
    .guia-head{display:flex;align-items:center;gap:16px;border-bottom:3px solid #1b6cb3;padding-bottom:18px}
    .guia-head .logo{flex-shrink:0}
    .guia-head .ci{flex:1}
    .guia-head .ci .marca{font-family:'Quicksand',sans-serif;font-weight:700;font-size:22px;color:#134b80}
    .guia-head .ci .marca span{color:#1b6cb3}
    .guia-head .ci .cl{font-size:13px;color:#6b7f90;margin-top:3px}
    .guia-head .doc{text-align:right}
    .guia-head .doc .t{font-family:'Quicksand',sans-serif;font-weight:700;font-size:15px;color:#134b80;text-transform:uppercase;letter-spacing:.04em}
    .guia-head .doc .proto{font-family:'Quicksand',sans-serif;font-weight:700;font-size:20px;color:#1b6cb3;margin-top:4px}
    .guia-meta{display:flex;justify-content:space-between;margin:18px 0 22px;font-size:13px;color:#6b7f90}
    .guia-sec{font-family:'Quicksand',sans-serif;font-weight:700;font-size:12px;color:#1b6cb3;text-transform:uppercase;letter-spacing:.07em;margin-bottom:10px;padding-bottom:6px;border-bottom:1px solid #e4edf5}
    ...
    .guia-tbl th{background:#134b80;color:#fff;font-family:'Quicksand',sans-serif;font-weight:600;text-align:left;padding:10px 12px;font-size:12px}
    ...
    .guia-tbl tfoot td{font-family:'Quicksand',sans-serif;font-weight:700;color:#134b80;border-top:2px solid #1b6cb3;border-bottom:none;font-size:14px}
    .guia-valor{display:inline-block;background:#F1F7FC;border:1px solid #d6e6f3;border-radius:10px;padding:8px 16px;font-family:'Quicksand',sans-serif;font-weight:700;font-size:18px;color:#134b80}
    /* rodapé assinaturas */
